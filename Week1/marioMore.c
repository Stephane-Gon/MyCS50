...
int main(void)
{
    ...
    while (height < 1 
           || height > 8); //This is a loop that keeps asking the user an height if they do not provide a int between 1 and 8 inclusive.
    ...
    for (int i = 0; i < height; i++) //This is the column maker
    {
        ...
        printf("  "); //This prints the gap between the 2 pyramids

        for (int l = 0; l <= i; l++) //And this is the loop that prints the pyramid after the gap.
        {
            printf("#");
        }
        printf("\n");
